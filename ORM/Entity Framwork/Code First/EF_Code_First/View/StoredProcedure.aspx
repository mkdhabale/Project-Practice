<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StoredProcedure.aspx.cs" Inherits="EF_Code_First.View.StoredProcedure" %>
...
<body>
    <form id="form1" runat="server">
        <div style="font-family: Arial">
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DataObjectTypeName="EF_Code_First.Model.Employees_StoredProcedure" DeleteMethod="DeleteEmployee" InsertMethod="InsertEmployee" SelectMethod="GetEmployees" TypeName="EF_Code_First.Repository.Employees_StoredProcedureRepository" UpdateMethod="UpdateEmployee"></asp:ObjectDataSource>
