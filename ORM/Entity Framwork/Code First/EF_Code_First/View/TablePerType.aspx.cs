...
namespace EF_Code_First.View
{
    public partial class TablePerType : System.Web.UI.Page
    {
        ...
        {
            PermanentEmployees_TablePerType permanentEmployee = new PermanentEmployees_TablePerType
            {
                FirstName = "Mike",
                LastName = "Brown",
                Gender = "Male",
        ...
        {
            ContractEmployees_TablePerType contractEmployee = new ContractEmployees_TablePerType
            {
                FirstName = "Stacy",
                LastName = "Josh",
                Gender = "Female",
