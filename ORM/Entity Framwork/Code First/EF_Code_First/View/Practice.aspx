<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Practice.aspx.cs" Inherits="EF_Code_First.View.Practice" %>
...
<body>
    <form id="form1" runat="server">
        <div style="font-family: Arial">
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetDepartments" TypeName="EF_Code_First.Repository.Employee"></asp:ObjectDataSource>
        </div>
    </form>
</body>
</html>
