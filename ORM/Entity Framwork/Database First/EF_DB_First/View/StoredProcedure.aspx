<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StoredProcedure.aspx.cs" Inherits="EF_DB_First.View.StoredProcedure" %>
...
<body>
    <form id="form1" runat="server">
        <div style="font-family: Arial">
            ...
            <asp:EntityDataSource ID="EntityDataSource1" runat="server" ConnectionString="name=Employee_StoredProcedure_DBContext" DefaultContainerName="Employee_StoredProcedure_DBContext" EnableDelete="True" EnableFlattening="False" EnableInsert="True" EnableUpdate="True" EntitySetName="Employees_StoredProcedure">
